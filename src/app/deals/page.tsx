      ...
      <main className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Limited-time offers and flash sales on premium products
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          ...
          {[1, 2, 3, 4, 5, 6].map((deal) => (
            <div
              key={deal}
              className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden relative"
            >
              ...
              <div className="aspect-square bg-gradient-to-br from-red-100 to-pink-100 flex items-center justify-center">
                <div className="w-24 h-24 bg-gradient-to-r from-red-500 to-pink-500 rounded-xl flex items-center justify-center">
                  <span className="text-white font-bold text-2xl">D{deal}</span>
                </div>
              </div>
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Amazing deal on this premium product with significant savings.
                </p>
